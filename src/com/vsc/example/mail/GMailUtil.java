...
public class GMailUtil {
	...
	public void sendMail(){
		...
		Session session = Session.getDefaultInstance(props,
			new javax.mail.Authenticator() {
				protected PasswordAuthentication getPasswordAuthentication() {
					return new PasswordAuthentication("tancoi@gmail.com","vocoiu1011");
				}
			});
		...
		try {
			...
			message.setFrom(new InternetAddress("tancoi@gmail.com"));
			message.setRecipients(javax.mail.Message.RecipientType.TO,
					InternetAddress.parse("pinkbeat@gmail.com"));
			message.setSubject("Chào Đức");
			message.setText("Dear Mr Đức," +
					"\n\n Đừng spam tôi nữa, làm ơn!", "UTF-8");
  ...
  public static void sendMessage(Gmail service, String userId, MimeMessage email)
    ...
    Send send = messages.send(userId, message);
